...
public class SNTPClient {
    ...
    // stores the NTP time when the recording was started
    public static long NtpStartTime;
    // the offset in ms between local time and the NTP server time
    public static long localTimeNtpTimeOffset;
    // stores the local device's time when the recording was started
    public static long localStartTime;
    ...
    public boolean requestTime(String host, int timeout) {
        ...
        try {
            ...
            NtpStartTime = requestTime + clockOffset;
            localTimeNtpTimeOffset = clockOffset;
            localStartTime = requestTime;

            // Debugging purposes
            Log.d("requestTag", "Request time returned: " + requestTime);
            Log.d("responseTag", "Response time returned: " + responseTime);
            Log.d("clockOffsetTag", "Clock offset returned: " + clockOffset);
            Log.d("myTag", "NTP time returned: " + mNtpTime);
            Log.d("roundTripTag", "Round trip time returned: " + mRoundTripTime);
            Log.d("ntpStartTimeTag", "NTP start time returned: " + NtpStartTime);
            Log.d("localTimeNtpTimeOffsetTag", "Local Time Ntp Time Offset returned: " + localTimeNtpTimeOffset);

        } catch (Exception e) {
            Log.d("exceptionTag", String.valueOf(e));

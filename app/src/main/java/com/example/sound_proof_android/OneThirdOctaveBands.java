 ...
 */
public class OneThirdOctaveBands {
     ...
     */
    public OneThirdOctaveBands(int samplingRate, FREQUENCY_BANDS frequency_bands, Context current) {
        ...
        InputStream input = this.current.getResources().openRawResource(R.raw.filter_coef);
        getFiltersParameters(input);
    }
